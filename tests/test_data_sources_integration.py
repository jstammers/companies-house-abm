...
class TestOnsGdpIntegration:
    ...
    def test_returns_nonempty_list(self) -> None:
        _skip_if_offline()
        from companies_house_abm.data_sources._http import clear_cache
...
class TestOnsAffordabilityRatioIntegration:
    ...
    def test_returns_positive_float(self) -> None:
        from companies_house_abm.data_sources.ons import fetch_affordability_ratio
...
class TestOnsRentalGrowthIntegration:
    ...
    def test_returns_float(self) -> None:
        from companies_house_abm.data_sources.ons import fetch_rental_growth
...
class TestOnsTenureDistributionIntegration:
    ...
    def test_returns_three_tenure_types(self) -> None:
        from companies_house_abm.data_sources.ons import fetch_tenure_distribution
...
class TestLandRegistryRegionalPricesIntegration:
    ...
    def test_returns_dict_of_floats(self) -> None:
        from companies_house_abm.data_sources._http import clear_cache
        from companies_house_abm.data_sources.land_registry import fetch_regional_prices
...
class TestOnsFetchTimeseriesUrlConstruction:
    ...
    def _captured_urls(self, series_ids: list[str]) -> list[str]:
        ...
        with patch(
            "companies_house_abm.data_sources.ons.retry", side_effect=_fake_retry
        ):
            from companies_house_abm.data_sources.ons import _fetch_timeseries
...
class TestOnsSeriesUriMapping:
    ...
    def test_series_uri_keys_are_uppercase(self) -> None:
        from companies_house_abm.data_sources.ons import _SERIES_URI
    ...
    def test_default_template_substitution(self) -> None:
        from companies_house_abm.data_sources.ons import _DEFAULT_URI_TEMPLATE
...
class TestBoeIadbUrlConstruction:
    ...
    def test_contains_series_code(self) -> None:
        from companies_house_abm.data_sources.boe import _build_iadb_url
...
class TestBoeParseIadbCsv:
    ...
    def test_parses_date_value_rows(self) -> None:
        from companies_house_abm.data_sources.boe import _parse_iadb_csv
...
class TestBoeFallbackBehaviourUnit:
    ...
    def test_fallback_is_current_bank_rate(self) -> None:
        ...
        from companies_house_abm.data_sources.boe import _FALLBACK_BANK_RATE
